...
let xLabel = svg.append('text').classed('xLabel',true).attr('x',450).attr('y',570).text('Month');
let yLabel = svg.append('text').classed('yLabel',true).attr('x',-300).attr('y',50).attr('transform','rotate(-90)').text('Relative Value');
